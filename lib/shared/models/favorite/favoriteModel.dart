...
class Favorite {
  ...
  factory Favorite.fromMap(Map<String, dynamic> json) => Favorite(
        codigoUnidadNegocio: json["CodigoUnidadNegocio"].toString(),
        codigoSede: json["CodigoSede"].toString(),
        nombreDuenio: json["NombreDuenio"].toString(),
        apellidosDuenio: json["ApellidosDuenio"],
        correoDuenio: json["CorreoDuenio"].toString(),
